  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-12">
      ...
      <div className="book-prose mt-10">
        ...
        <h2>어떻게 만드나 — 편집 방침</h2>
        <p>
          이 사이트의 서적은 <strong>초안 작성과 편집을 분리한 과정</strong>을 거칩니다. 조사와
          초안 작성 단계에서는 최신 릴리스 노트·공식 문서·개발자 서베이 같은 자료를 폭넓게
          훑기 위해 도구의 도움을 받고, <strong>발행 여부는 사람이 판단합니다.</strong>
        </p>
        <p>구체적으로 다음 기준을 통과하지 못한 원고는 발행하지 않습니다.</p>
        <ul>
          <li>
