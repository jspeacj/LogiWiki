  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-12">
      ...
      <div className="book-prose mt-10">
        ...
        {/*
          이 문장이 없으면 4항이 "쿠키 = 로그인 유지용" 이라고 단정하는 것으로 읽혀 5항의
          광고 쿠키 고지와 정면으로 어긋난다. 개인정보처리방침 안에서 서로 모순되는 고지는
          그 자체로 심사 감점이고, 이용자에게도 사실과 다른 안내가 된다.
        */}
        <p>
          이 밖에 광고 목적의 제3자 쿠키가 사용될 수 있으며, 이에 대한 내용과 거부 방법은 아래
          5항에서 안내합니다.
        </p>
        ...
        <ul>
          ...
          {/*
            DoubleClick DART 쿠키를 **이름으로** 밝힌다. 앞 항목의 서술로 실질 내용은 이미
            덮이지만, Google 이 게시자에게 안내하는 표준 문구가 이 명칭을 쓰기 때문에 심사·문의
            대응에서 확인이 쉬워진다(내용을 바꾸는 게 아니라 같은 사실을 표준 용어로 적는 것).
          */}
          <li>
            Google 은 <strong>DoubleClick DART 쿠키</strong> 를 비롯한 광고 쿠키를 사용하여, 이용자가
            본 사이트 또는 다른 사이트를 방문한 기록을 바탕으로 Google 및 파트너가 광고를 제공하도록
            합니다.
          </li>
          <li>
            이용자는{" "}
